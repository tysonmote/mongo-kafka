...
import com.rippling.kafka.connect.avro.TweetMsg;
import com.rippling.kafka.connect.mongodb.MongoKafkaTestCase;
import com.rippling.kafka.connect.util.jmx.SinkTaskStatistics;
...
class MongoSinkConnectorIntegrationTest extends MongoKafkaTestCase {
  ...
  private void assertMetrics() {
    ...
    String mBeanName =
        "com.rippling.kafka.connect:type=sink-task-metrics,connector=MongoSinkConnector,task=sink-task-0";
