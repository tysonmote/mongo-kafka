...
package com.rippling.kafka.connect.source.producer;
...
import static com.rippling.kafka.connect.source.schema.AvroSchemaDefaults.DEFAULT_KEY_SCHEMA;
import static com.rippling.kafka.connect.source.schema.AvroSchemaDefaults.DEFAULT_VALUE_SCHEMA;
import static com.rippling.kafka.connect.source.schema.BsonDocumentToSchema.DEFAULT_FIELD_NAME;
import static com.rippling.kafka.connect.source.schema.SchemaUtils.assertSchemaAndValueEquals;
...
import com.rippling.kafka.connect.source.json.formatter.ExtendedJson;
