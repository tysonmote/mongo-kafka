...
package com.rippling.kafka.connect.sink.writemodel.strategy;

import static com.rippling.kafka.connect.sink.MongoSinkTopicConfig.ID_FIELD;
import static com.rippling.kafka.connect.sink.writemodel.strategy.WriteModelHelper.flattenKeys;
...
import com.rippling.kafka.connect.sink.Configurable;
