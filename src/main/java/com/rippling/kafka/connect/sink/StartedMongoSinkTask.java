...
import static com.rippling.kafka.connect.sink.MongoSinkTask.LOGGER;
import static com.rippling.kafka.connect.sink.MongoSinkTopicConfig.BULK_WRITE_ORDERED_CONFIG;
import static com.rippling.kafka.connect.util.TimeseriesValidation.validateCollection;
...
import com.rippling.kafka.connect.sink.dlq.AnalyzedBatchFailedWithBulkWriteException;
import com.rippling.kafka.connect.sink.dlq.ErrorReporter;
...
import com.rippling.kafka.connect.util.jmx.internal.MBeanServerUtils;
...
import com.rippling.kafka.connect.util.time.Timer;
...
final class StartedMongoSinkTask implements AutoCloseable {
  ...
  private String getMBeanName() {
    ...
    return "com.rippling.kafka.connect:type=sink-task-metrics,connector="
        + connectorName
        + ",task=sink-task-"
        + id;
  }
