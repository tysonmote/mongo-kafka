...
package com.rippling.kafka.connect.source.topic.mapping;

import static com.rippling.kafka.connect.source.MongoSourceConfig.TOPIC_NAMESPACE_MAP_CONFIG;
import static com.rippling.kafka.connect.source.MongoSourceConfig.TOPIC_PREFIX_CONFIG;
import static com.rippling.kafka.connect.source.MongoSourceConfig.TOPIC_SEPARATOR_CONFIG;
...
import static com.rippling.kafka.connect.util.ConfigHelper.documentFromString;
