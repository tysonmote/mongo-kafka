 ...
 */
package com.rippling.kafka.connect.source.statistics;
...
import com.rippling.kafka.connect.util.jmx.internal.CombinedMongoMBean;
...
public final class JmxStatisticsManager implements StatisticsManager {
  ...
  private static String getMBeanName(final String mBean, final String connectorName) {
    ...
    return "com.rippling.kafka.connect:type=source-task-metrics,connector="
        + connectorName
        + ",task="
        + mBean
        + "-"
