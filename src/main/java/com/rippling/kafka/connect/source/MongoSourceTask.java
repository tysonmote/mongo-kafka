...
import static com.rippling.kafka.connect.source.MongoSourceConfig.PROVIDER_CONFIG;
import static com.rippling.kafka.connect.util.Assertions.assertNotNull;
import static com.rippling.kafka.connect.util.ConfigHelper.getMongoDriverInformation;
import static com.rippling.kafka.connect.util.ServerApiConfig.setServerApi;
import static com.rippling.kafka.connect.util.SslConfigs.setupSsl;
...
import com.rippling.kafka.connect.source.statistics.JmxStatisticsManager;
import com.rippling.kafka.connect.source.statistics.StatisticsManager;
import com.rippling.kafka.connect.util.ResumeTokenUtils;
